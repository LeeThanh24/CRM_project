          ...
          <div class="white-box">
            <form class="form-horizontal form-material">
              <div class="form-group">
                <label class="col-md-12">Choose task name</label>
                <div class="col-md-12">
                  <select id="task" class="form-control form-control-line">
                    <c:forEach items="${tasks}" var="item">
                      <option taskId=${item.getTaskName()}>${item.getTaskName()}</option>
                    </c:forEach>
                  </select>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-12">Choose project</label>
                <div class="col-md-12">
                  <select id="jobs" class="form-control form-control-line">
                    <c:forEach items="${jobs}" var="item">
                      <option job_id=${item.getId()}>${item.getName()}</option>
                    </c:forEach>
                ...
                <div class="col-md-12">
                  <select id ="doer" class="form-control form-control-line">
                    <c:forEach items="${users}" var="item">
                      <option doer_id =${item.getId() }>${item.getName()}</option>
                    </c:forEach>
                  </select>
                </div>
              </div>
                ...
                <div class="col-md-12">
                  <select id ="status" class="form-control form-control-line">
                    <c:forEach items="${status}" var="item">
                      <option status_id=${item.getId()}>${item.getName()}</option>
                    </c:forEach>
                  </select>
                </div>
              </div>
