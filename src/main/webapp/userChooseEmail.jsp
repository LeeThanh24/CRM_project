    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-xs-12">
          <div class="white-box">
            <form class="form-horizontal form-material" action="http://localhost:8080/userUpdate" method = "get">
...
<%--              </div>--%>
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <select id="email"  class="form-control form-control-line" name  ="email">
...
<%--              <div class="col-md-12">--%>
<%--                <input id="avatar" type="text" value =${avatar} placeholder=""--%>
<%--                       class="form-control form-control-line"></div>--%>
<%--            </div>--%>
