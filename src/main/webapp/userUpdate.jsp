...
<%--                <div class="col-sm-12">--%>
<%--                  <select id="email"  class="form-control form-control-line">--%>
...
<%--              </div>--%>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-12">
                                ...
                                <input id="fullname"  type="text" value= "<%=fullname%>" placeholder=""
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-12">
                              <select id = "ava"  class="form-control form-control-line">

                                  <option avaId ="1" >Male</option>
                                  <option  avaId ="2" >Female</option>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                <select id="country" class="form-control form-control-line">
                              ...
                              <div class="col-sm-12">
                                <select id="role"  class="form-control form-control-line">
                                  <c:forEach items="${roles}" var="item">
                                    <option role_id =${item.getId()} >${item.getRoleName()}</option>
                                  </c:forEach>
                                </select>
                              </div>
                            </div>
              <div class="form-group">
                <div class="col-sm-12">
                  ...
                  <%--                  <a href="http://localhost:8080/usersRoles" class="btn btn-primary">Continue</a>--%>
                  <a href="http://localhost:8080/userChooseEmail" class="btn btn-primary">Back</a>
                </div>
              </div>
            </form>
          </div>
